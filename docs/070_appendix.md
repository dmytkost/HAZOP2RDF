...
```{.ttl caption="HAZOP RDF ontology in Turtle format (short version)"}
...
![HAZOP RDF graph (short version)](images/example_hazop_case_graph.png)

![HAZOP output in Excel](images/graph_ontology_excel.png)
